...
def _test():
	TEST_LATLNG = (45.104, -123.208)
	TEST_GRIDSQUARE = "CN85jc"
	assert to_gridsquare(*TEST_LATLNG) == TEST_GRIDSQUARE
	assert to_latlng(TEST_GRIDSQUARE) == TEST_LATLNG
	assert to_gridsquare(*to_latlng(TEST_GRIDSQUARE)) == TEST_GRIDSQUARE
	assert to_latlng(to_gridsquare(*TEST_LATLNG)) == TEST_LATLNG
